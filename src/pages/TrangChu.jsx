...
import { TieuDeTinTuc, TieuDeTranTiepTheo, TieuDeSoLieu } from '../components/TieuDeMuc';
        ...
        <div className="container">
          <div className="hero-body">
            ...
            <p className="hero-mota">
              Trang chu chinh thuc cua doi tuyen bong da. Cap nhat tin tuc, ty so,
              va thong tin moi nhat ve cau thu va tran dau.
            </p>
